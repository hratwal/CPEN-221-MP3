 ...
 */
public class Humans implements ArenaAnimal {
	 ...
	 */
	public Humans(AI humanAI, Location initialLocation) {
		ai = humanAI;
	...
	public LivingItem breed() {
		Humans child = new Humans(ai, location);
